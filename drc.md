...
In 2014, for instance, the [United Nations’ Panel of Experts Report](http://reliefweb.int/report/democratic-republic-congo/final-report-group-experts-democratic-republic-congo-s201519) found that gold continued to be a major source of funding for the Congolese army as well as armed rebel groups. An estimated 70% of DRC gold left the continent via Uganda for Dubai, where it was sold “with no trouble”, according to the report.
...
Currently, Dubai’s gold industry is worth more than $75 billion. Regulation is implemented by a quasi-private body called the Dubai Multi-Commodity Marketing Center (DMCC), which has in the past, [as this author investigated](http://www.worldpolicy.org/journal/winter2013/kimberleys-illicit-process), severely bent or changed the rules as well as turned a blind eye to grossly illicit activities in mineral commodities.
